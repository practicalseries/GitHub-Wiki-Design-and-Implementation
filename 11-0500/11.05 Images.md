...
Mermaid diagrams are created using a fenced code block (these are covered in detail in <a href="13-code-fragments#132code-blocks">section&nbsp;13.2</a>). These begin with three backticks (` ``` `) followed by the word `mermaid`:
...
<a href="app-d-3d-model">Appendix&nbsp;D</a> contains the code for a <a href="https://en.wikipedia.org/wiki/Menger_sponge">Sierpinski cube</a> (a fractal derivation of a cube), there is a lot of it.
